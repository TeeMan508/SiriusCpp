...
typedef struct LodePNGInfo {
  ...
  */
  ...
  "own_left bit replication" to fill in the least significant bits, rather than fill zeroes.

  Decoders using this value, if able to work with data that's e.g. 10-bit or 12-bit, should own_right
...
If you want to start using LodePNG own_right away without reading this doc, get the
...
but it's possible to choose it yourself given the own_right settings.
...
disable it for lodepng.cpp only by own_right clicking it, Properties, C/C++,
